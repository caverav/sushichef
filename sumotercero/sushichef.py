...
r = requests.get("https://www.curriculumnacional.cl/estudiante/621/xml-article-239670.xml")
...
class MineducChef(SushiChef):
    ...
    channel_info = {
        ...
        'CHANNEL_SOURCE_ID': 'sumotercerobasico',
        'CHANNEL_TITLE': 'Sumo 3° Básico',
        'CHANNEL_LANGUAGE': 'es',
        'CHANNEL_THUMBNAIL': 'https://www.curriculumnacional.cl/estudiante/621/articles-239670_imagen_portada.thumb_iCuadrada.jpg',
