...
r = requests.get("https://www.curriculumnacional.cl/estudiante/621/xml-article-239666.xml")
...
class MineducChef(SushiChef):
    ...
    channel_info = {
        ...
        'CHANNEL_SOURCE_ID': 'leoYAprendo4eroBasico',                   # channel's unique id
        'CHANNEL_TITLE': 'Leo 4° Básico',
        'CHANNEL_LANGUAGE': 'es',
        'CHANNEL_THUMBNAIL': 'https://www.curriculumnacional.cl/estudiante/621/articles-239666_imagen_portada.thumb_iCuadrada.jpg', # (optional) local path or url to image file
