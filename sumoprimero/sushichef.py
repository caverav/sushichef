...
r = requests.get("https://www.curriculumnacional.cl/estudiante/621/xml-article-239668.xml")
...
class MineducChef(SushiChef):
    ...
    channel_info = {
        ...
        'CHANNEL_SOURCE_ID': 'sumo1erobasico',
        'CHANNEL_TITLE': 'Sumo 1° Básico',
        'CHANNEL_LANGUAGE': 'es',
        'CHANNEL_THUMBNAIL': 'https://www.curriculumnacional.cl/estudiante/621/articles-239668_imagen_portada.thumb_iCuadrada.jpg',
