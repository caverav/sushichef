...
r = requests.get("https://www.curriculumnacional.cl/estudiante/621/xml-article-239669.xml")
...
class MineducChef(SushiChef):
    ...
    channel_info = {
        ...
        'CHANNEL_SOURCE_ID': 'sumosegundobasico',
        'CHANNEL_TITLE': 'Sumo 2° Básico',
        'CHANNEL_LANGUAGE': 'es',
        'CHANNEL_THUMBNAIL': 'https://www.curriculumnacional.cl/estudiante/621/articles-239669_imagen_portada.thumb_iCuadrada.jpg',
