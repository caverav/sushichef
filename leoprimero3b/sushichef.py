...
r = requests.get("https://www.curriculumnacional.cl/estudiante/621/xml-article-239665.xml")
...
class MineducChef(SushiChef):
    ...
    channel_info = {
        ...
        'CHANNEL_SOURCE_ID': 'leoYAprendo3eroBasico',                   # channel's unique id
        'CHANNEL_TITLE': 'Leo 3° Básico',
        'CHANNEL_LANGUAGE': 'es',
        'CHANNEL_THUMBNAIL': 'https://www.curriculumnacional.cl/estudiante/621/articles-239665_imagen_portada.thumb_iCuadrada.jpg', # (optional) local path or url to image file
